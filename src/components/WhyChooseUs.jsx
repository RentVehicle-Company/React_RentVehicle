        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURES.map(({ icon: Icon, title, text }, index) => (
            <Reveal key={title} delay={index * 100}>
              <TiltCard className="group flex h-full flex-col items-center gap-3 rounded-2xl border border-borderColor dark:border-slate-700 bg-white dark:bg-slate-800 p-6 text-center shadow-sm transition-all duration-200 ease-out hover:shadow-md">
