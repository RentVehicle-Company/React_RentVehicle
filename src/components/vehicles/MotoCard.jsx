      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-0.5 text-xs text-slate-500">{moto.category}</p>
          </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-x-2 gap-y-2 border-t border-slate-100 pt-3 text-[11px] text-slate-600">
          <span className="inline-flex min-w-0 items-center gap-2">
            <LuCog size={13} className="shrink-0 text-slate-500" />
          ...
          <span className="inline-flex min-w-0 items-center gap-2">
            <LuGauge size={13} className="shrink-0 text-slate-500" />
        ...
        <div className="mt-4 flex gap-2">
          ...
          <button
            type="button"
            onClick={() => navigate(`/vehicles/${moto.id}`)}
